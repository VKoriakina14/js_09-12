...
/*    Це багаторядковий коментар.
   ...
   Для того, щоб створити його потрібно виділити сроки та нажати alt + shift + a  (Mac - option + shift +a  )
...
/* const 1login = 'Вася'; //цифри на початку!
const log-in = 'Вася';  //дефіс!!
const % = '%'; // Оголошено змінну з ім'ям "%"
const - = '--'; // Тепер змінна з ім'ям "-"
const return = 'повернення'; // зарезервоване слово! */

// А ось так вже можна
/* const login = 'vasja';
const log_in = 'vasja';
const login123 = 'vasja';
const $ = 'дивна зміна';
const _ = 'А чому ні?';
console.log(імя); */
...
// ---String---
/* const str = "Ми вже так 100 разів робили";
console.log(str);
const str2 = 'QA pro'; // Зверніть увагу, лапки одинарні, і це цілком собі законно та не має ніякої різниці між ""
console.log(str2); */
...
/* const productName = "Синя футболка";
console.log(productName.includes("ф")); // ВИХІД: "СИНЯ ФУТБОЛКА"
console.log(productName.includes("c")); */
...
let greetings = `Вітаємо на курсі, ${userName.toUpperCase()}!`;
console.log(greetings); // Вихід: "Вітаємо на курсі, АННА!"
 */

// --- Number ---
const n = 12; //Це number
const float = 12.345; //І це також Number
const number = 0x2a; // шістнадцятирічна система
console.log(n);
console.log(float);
console.log(number)
...
const negativeInfinity = -10/0;
console.log(negativeInfinity) */ // -Infinity

/* const num = "123" // рядок, sting
console.log(num);
console.log(typeof num); // "string"
const convertedNumber = Number(num);  // перетворення рядка в число
console.log(convertedNumber); // 123
console.log(typeof convertedNumber); // "number" */

/* const invalidNum = "abc";
console.log(invalidNum);
const convertedInvalidNum = Number(invalidNum);
console.log(convertedInvalidNum); // NaN
console.log(typeof convertedInvalidNum); // "number" */

const buttonSize = "11.22sadxas";
const convertedButtonSize = Number.parseFloat(buttonSize); // Видаляє "px" і перетворює в число
console.log(convertedButtonSize); // 55
console.log(typeof convertedButtonSize); // "number"
...
console.log(sym1 === sym2); // false, оскільки кожен символ є унікальним
 */
...
// const bigInt2 = 8888999999881124n;
...
//--------------------------------------------------------------------------------------
//--- Динамічна типізація. Одна й та змінна може бути будь-ким
