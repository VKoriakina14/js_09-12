...
4. Як можна вивести на екран yci значения масиву, коли розмір масиву заздалегздь невідомий? 

5. Що таке цикл for ... of?

6. Як можна видалити певне значения з масиву?
splice(index, count) 

const arr = [1, 2, 3, 4, 5];
arr.splice(2, 2); // Видалити 2 елементи, починаючи з індексу 2
console.log(arr);

const numbers = [1, 2, 3, 4, 5];
console.log(numbers.splice(1, 2, 7)); // [2, 3]
console.log(numbers)

const somethingDoesntBelong = [1, 2, 3, "oops", 5, 6];
console.log(somethingDoesntBelong.splice(3, 1, 4));
console.log(somethingDoesntBelong);
...
7. Як додати нове значения в кінець масиву? 

8. Як додати нове значения на початок масиву?

9. Як можна об'еднати два масиви?
concat()
... 
const arr1 = [1,2,3]
const arr2 = [4,5]
...
10. Як можна дізнатися, за яким індексом у массиві розташоване потрібне нам значения?
...
/* Якщо скобочна група потрібна нам тільки для угрупування елементів і
ми не хочемо "заплямовувати" її захоплюючими групами, ми використовуємо (?:...), 
яка створює незахоплюючу групу. Це дозволяє нам угруповувати частини шаблону без збереження
їх у змінних $1, $2 тощо. */
...
/* У регулярних виразах \b є метасимволом, який позначає границю слова. 
